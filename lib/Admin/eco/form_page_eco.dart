...
class MyCustomFormState extends State<MyCustomForm> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.id != null ? "Actualizar EcoNovedad" : "Agregar EcoNovedad"),
      ),
      body: Padding(
              ...
              children: <Widget>[
                      ...
                      child: Stack(
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            child: Text(
                              widget.id != null ? "Editar Imagen" : "Subir Imagen",
                              style: TextStyle(
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(
                    ...
                    hintText: 'Escriba el EcoTitutlo',
                    labelText: 'Titulo',
                  ),
                ),
                TextFormField(
                  ...
                  decoration: const InputDecoration(
                    ...
                    hintText: 'Escriba la EcoDescripcion',
                ...
                Container(
                  ...
                  child: new OutlinedButton(
                    child: Text(widget.id != null ? "Actualizar" : "Agregar"),
                    onPressed: () {
                      var data = {
                        'titulo': _titleTEC.text,
                        'descripcion': _subtitletownTEC.text,
                        'image': widget.imgUrl
                      };
                      if (widget.id != null) {
