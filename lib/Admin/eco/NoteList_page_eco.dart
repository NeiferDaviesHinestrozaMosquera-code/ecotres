  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                            ...
                            if (check) {
                              ...
                              space = Container(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  labelText: 'Resultado de la busqueda',
                                  hintText: 'Resultado de la busqueda',
                                ),
                                autofocus: false,
      ...
      body: StreamBuilder(
        ...
        stream: FirebaseFirestore.instance.collection('EcoNovedad').snapshots(),
                            ...
                            child: length == 0
                                ...
                                : ListView.builder(
                                    ...
                                    itemBuilder:
                                      ...
                                      return ListTile(
                                        title: Text(
                                            note.elementAt(index)['titulo']),
                                        subtitle: Text(
                                            note.elementAt(index)['descripcion']),
                                      );
                                    }),
                          ),
                        )
