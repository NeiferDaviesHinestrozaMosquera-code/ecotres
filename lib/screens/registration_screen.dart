...
final firstNameField = TextFormField(
        ...
        validator: (value) {
          ...
          if (!regex.hasMatch(value)) {
            return ("Introduzca un nombre válido (mínimo 3 caracteres)");
          }
          return null;
        },
        onSaved: (value) {
  ...
  //second name field
    final secondNameField = TextFormField(
        ...
        validator: (value) {
          if (value!.isEmpty) {
            return ("El segundo nombre no puede estar vacío");
          }
          return null;
        },
        onSaved: (value) {
    ...
    final emailField = TextFormField(
        ...
        validator: (value) {
          if (value!.isEmpty) {
            return ("Por favor introduzca una dirección de correo electrónico");
          }
    ...
    final passwordField = TextFormField(
        ...
        validator: (value) {
          ...
          if (!regex.hasMatch(value)) {
            return ("Introduzca una contraseña válida (6 caracteres como mínimo)");
          }
        },
        onSaved: (value) {
          firstNameEditingController.text = value!;
...
//xx//
  ...
  postDetailsToFirestore() async {
    ...
    userModel.secondName = secondNameEditingController.text; //aca se envia la informacion al modal de firebase

    await firebaseFirestore
        .collection("users")
        .doc(user.uid)
        .set(userModel.toMap());
    Fluttertoast.showToast(msg: "Cuenta creada con éxito :) "); ///Cuenta creada con exito

    Navigator.pushAndRemoveUntil(
        (context),
    
        MaterialPageRoute(builder: (context) =>  LoginScreen()), ///Envia a la pagina de login
        (route) => false);
  }
}